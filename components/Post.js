    ...
    <div className='flex flex-col'>
        ...
        {postImage && (
            <div className='relative h-56 md:h-96 bg-white'>
                <Image src={postImage} objectFit="cover" layout='fill' alt="postImage"/>
            </div>
        )}

        <div className='bg-white shadow-md text-gray-400 border-t flex justify-between items-center rounded-b-2xl'>
